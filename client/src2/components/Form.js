        ...
        <div>
            <form className='ourForm main-form' >
                <div class="form-group">
                    <label><p>Имя</p></label>
                    <input type="text" name="NAME" value={NAME} class="form-control" onChange={(e)=>{ChangeNAME(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>Должность</p></label>
                    <input type="text" name="POSITION" value={POSITION} class="form-control" onChange={(e)=>{ChangePOSITION(e)}}></input></div>
                <div class="form-group">
                    <label><p>Кабинет</p></label>
                    <input type="text" name="CABINET" value={CABINET} class="form-control" onChange={(e)=>{ChangeCABINET(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>IP</p></label>
                    <input type="text" name="IP" value={IP} class="form-control" onChange={(e)=>{ChangeIP(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>Точка</p></label>
                    <input type="text" name="ENTER_POINT" value={ENTER_POINT} class="form-control" onChange={(e)=>{ChangeENTER_POINT(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>Системный блок</p></label>
                    <input type="text" name="DESCTOP"  value={DESCTOP} class="form-control" onChange={(e)=>{ChangeDESCTOP(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>Монитор</p></label>
                    <input type="text" name="MONITOR"  value={MONITOR} class="form-control" onChange={(e)=>{ChangeMONITOR(e)}}></input>
                </div>
                <div class="form-group">
                    <label><p>Принтер</p></label>
                    <input type="text" name="PRINTER"  value={PRINTER} class="form-control" onChange={(e)=>{ChangePRINTER(e)}}></input>
                </div>
                <div class="form-group">
